...
if (-not $env:TAURI_SIGNING_PRIVATE_KEY) {
    ...
    Write-Host "     Get-Content .tauri\adamant.key -Raw" -ForegroundColor Gray
    Write-Host ""
    ...
    Write-Host "     `$env:TAURI_SIGNING_PRIVATE_KEY = Get-Content .tauri\adamant.key -Raw" -ForegroundColor Gray
