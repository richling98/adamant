...
export function TranscriptPanel({
  ...
  return (
    <div ref={transcriptContainerRef} className="w-full border-r border-white/10 bg-background flex flex-col overflow-y-auto">
      {/* Title area - Sticky header */}
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur-xl p-4 border-b border-white/10">
