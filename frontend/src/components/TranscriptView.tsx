                ...
                {isStreaming ? (
                  ...
                  <div className="bg-black/25 border border-white/10 rounded-lg px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                    <div className="relative">
                      <p className="text-base text-foreground/90 leading-relaxed" style={{ visibility: 'hidden' }}>
                        {sizerText}
                      </p>
                      <p className="text-base text-foreground/90 leading-relaxed absolute top-0 left-0">
                        {displayText}
                      </p>
                    </div>
                  </div>
