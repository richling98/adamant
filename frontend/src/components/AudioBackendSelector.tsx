    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-zinc-800 text-white rounded-lg shadow-lg border border-white/10">
      ...
      {error && (
        <div className="p-2 text-xs text-red-400 bg-red-900/20 border border-red-800/30 rounded-md">
          {error}
        </div>
      )}
