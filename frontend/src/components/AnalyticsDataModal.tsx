...
export default function AnalyticsDataModal({ isOpen, onClose, onConfirmDisable }: AnalyticsDataModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-[#161b22] border border-white/10 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.03]">
              <h4 className="font-semibold text-zinc-200 mb-2">1. Model Preferences</h4>
              ...
              <p className="text-xs text-zinc-600 mt-2 italic">Helps us understand which models users prefer</p>
            </div>

            {/* Meeting Metrics */}
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.03]">
              <h4 className="font-semibold text-zinc-200 mb-2">2. Anonymous Meeting Metrics</h4>
              <ul className="text-sm text-zinc-400 space-y-1 ml-4">
              ...
              <p className="text-xs text-zinc-600 mt-2 italic">Helps us optimize performance and understand usage patterns</p>
            </div>

            {/* Device Types */}
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.03]">
              <h4 className="font-semibold text-zinc-200 mb-2">3. Device Types (Not Names)</h4>
              <ul className="text-sm text-zinc-400 space-y-1 ml-4">
                <li>• Microphone type: "Bluetooth" or "Wired" or "Unknown"</li>
                <li>• System audio type: "Bluetooth" or "Wired" or "Unknown"</li>
              </ul>
              <p className="text-xs text-zinc-600 mt-2 italic">Helps us improve compatibility, NOT the actual device names</p>
            </div>

            {/* Usage Patterns */}
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.03]">
              <h4 className="font-semibold text-zinc-200 mb-2">4. App Usage Patterns</h4>
              <ul className="text-sm text-zinc-400 space-y-1 ml-4">
              ...
              <p className="text-xs text-zinc-600 mt-2 italic">Helps us improve user experience</p>
            </div>

            {/* Platform Info */}
            <div className="border border-white/10 rounded-lg p-4 bg-white/[0.03]">
              <h4 className="font-semibold text-zinc-200 mb-2">5. Platform Information</h4>
              <ul className="text-sm text-zinc-400 space-y-1 ml-4">
              ...
              <p className="text-xs text-zinc-600 mt-2 italic">Helps us prioritize platform support</p>
            </div>
          </div>

          {/* What We DON'T Collect */}
          <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
            <h4 className="font-semibold text-red-300 mb-2">What We DON'T Collect:</h4>
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-lg p-4">
            <h4 className="font-semibold text-zinc-300 mb-2">Example Event:</h4>
  ...
  "had_fatal_error": "false"
        ...
        {/* Footer */}
        <div className="flex items-center justify-between gap-4 p-6 border-t border-white/10 bg-white/[0.02]">
          <button
            onClick={onClose}
            className="px-4 py-2 text-zinc-300 bg-white/5 border border-white/10 rounded-md hover:bg-white/10 transition-colors"
          >
