        ...
        <div id={`segment-${id}`} className="mb-3">
            <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                    {isStreaming ? (
                        <div className="bg-black/25 border border-white/10 rounded-lg px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                            <p className="text-base text-foreground/90 leading-relaxed break-words">{displayText}</p>
                        </div>
                    ) : (
                        <p className="text-base text-foreground/90 leading-relaxed break-words">{displayText}</p>
                    )}
...
export const VirtualizedTranscriptView: React.FC<VirtualizedTranscriptViewProps> = ({
    ...
    return (
        <div ref={scrollRef} className="flex flex-col h-full overflow-y-auto px-4 py-2">
            ...
            <AnimatePresence>
                {isRecording && (
                    <div className="sticky top-0 z-10 bg-card/80 backdrop-blur-xl pb-2">
                    ...
                    {isRecording ? (
                        <>
                            <div className="flex items-center justify-center mb-3">
                                <div className={`w-3 h-3 rounded-full ${isPaused ? 'bg-amber-400' : 'bg-emerald-400 animate-pulse'}`}></div>
                            </div>
                        ...
                        <>
                            <p className="text-lg font-semibold">Welcome to Adamant!</p>
                        ...
                        <div ref={loadMoreTriggerRef} className="flex justify-center items-center py-4 mt-2">
                            {isLoadingMore ? (
                                <div className="flex items-center gap-2 text-foreground/60">
                                    <div className="w-4 h-4 border-2 border-foreground/20 border-t-foreground/70 rounded-full animate-spin" />
