...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/adamant/meeting_minutes.db',  // Apple Silicon (M1/M2/M3)
  '/usr/local/var/adamant/meeting_minutes.db',      // Intel Macs
];
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Previous Adamant Installation Detected!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            We found an existing database from your previous Adamant installation (Python backend version).
          </p>
