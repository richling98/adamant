  ...
  const handleBrowse = async () => {
    try {
      ...
      if (dbPath) {
        ...
        setErrorMessage('No database found at selected location. Please select the Adamant folder, backend folder, or the database file directly.');
  ...
  return (
    <Dialog open={isOpen} onOpenChange={() => {}}>
      <DialogContent className="sm:max-w-[600px]" onPointerDownOutside={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Adamant!</DialogTitle>
          <DialogDescription className="text-base pt-2">
            Do you have data from a previous Adamant installation?
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <p className="text-sm text-gray-600">
              Select your previous Adamant folder, backend directory, or database file:
            </p>
