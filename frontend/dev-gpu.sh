#!/bin/bash
# GPU-accelerated development script for Adamant
...
echo -e "${BLUE}🚀 Adamant GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting Adamant in development mode...${NC}"
echo ""
