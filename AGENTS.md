...
**Adamant** is a privacy-first AI meeting assistant that captures, transcribes, and summarizes meetings entirely on local infrastructure. The project consists of two main components:
...
- **LLM Integration**: Ollama (local), Codex, Groq, OpenRouter
...
- **Production (macOS)**: `~/Library/Application Support/Adamant/models/`
- **Production (Windows)**: `%APPDATA%\Adamant\models\`
